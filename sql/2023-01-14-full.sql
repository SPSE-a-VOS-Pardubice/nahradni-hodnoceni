...
-- Sun 15 Jan 2023 01:08:10 PM CET
...
CREATE TABLE IF NOT EXISTS `zkousky`.`Tridy` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_Třídy_Učitelé2_idx` (`tridni_ucitel_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `zkousky`.`Studenti` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_Studenti_Třídy1_idx` (`trida_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `zkousky`.`Ucebny` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `oznaceni_UNIQUE` (`oznaceni` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `zkousky`.`Zkousky` (
  ...
  `termin_konani` DATETIME NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_Zkousky_Studenti1_idx` (`student_id` ASC) VISIBLE,
  INDEX `fk_Zkousky_Ucebny1_idx` (`ucebna_id` ASC) VISIBLE,
  INDEX `fk_Zkousky_Predmety1_idx` (`predmet_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `zkousky`.`UciteleUZkousek` (
  ...
  INDEX `fk_Zkousky_has_Ucitele_Ucitele1_idx` (`Ucitele_idUcitele` ASC) VISIBLE,
  INDEX `fk_Zkousky_has_Ucitele_Zkousky1_idx` (`Zkousky_id` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `zkousky`.`SubjectsTraits`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zkousky`.`SubjectsTraits` (
...
-- -----------------------------------------------------
-- Table `zkousky`.`ClassroomsTraits`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `zkousky`.`ClassroomsTraits` (
...
CREATE TABLE IF NOT EXISTS `zkousky`.`VhodnostUcitelu` (
  ...
  INDEX `fk_Predmety_has_Ucitele_Ucitele1_idx` (`ucitel_id` ASC) VISIBLE,
  INDEX `fk_Predmety_has_Ucitele_Predmety1_idx` (`predmet_id` ASC) VISIBLE,
