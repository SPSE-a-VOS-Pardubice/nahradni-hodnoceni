...
CREATE TABLE IF NOT EXISTS `nahradni_hodnoceni`.`Exams` (
  ...
  `original_mark` VARCHAR(1) NOT NULL,
  `final_mark` VARCHAR(1) NOT NULL,
  `time` DATETIME NULL,
...
-- -----------------------------------------------------
-- Table `nahradni_hodnoceni`.`TeacherSuitabilities`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `nahradni_hodnoceni`.`TeacherSuitabilities` (
  `subject_id` INT NOT NULL,
